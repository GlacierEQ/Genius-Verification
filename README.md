...
- Model checking & formal specification (TLA+, Alloy, Dafny, Lean, …)
- Fault injection as a verification surface
...
| Mastery map / vector / retention | Seed |
| Claims | Mapped examples only |
| Sources | High-authority nucleus |
